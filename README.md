...
Boilerplate for developing a WordPress theme using WebPack, Advanced Custom Fields, [Wpappy library](https://github.com/wpappy/wpappy) and other helpful solutions.
