# Wpappy Starter Theme

Boilerplate for developing a WordPress theme (hereinafter referred to as the application) using WebPack, Advanced Custom Fields, [Wpappy library](https://github.com/wpappy/wpappy) and other helpful solutions.
...
```
- Search for `My_Theme` in the application root directory to capture default PHP namespace and replace it with your own.
- Also search for `my-theme` to replace the default CSS class prefixes.
...
## License
Wpappy Starter Theme is free software, and is released under the terms of the GPL (GNU General Public License) version 2 or (at your option) any later version. See [LICENSE](https://github.com/wpappy/starter-theme/blob/main/LICENSE).
